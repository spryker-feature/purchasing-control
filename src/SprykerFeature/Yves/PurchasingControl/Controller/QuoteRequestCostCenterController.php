 ...
 */
class QuoteRequestCostCenterController extends AbstractQuoteRequestCostCenterController
{
    protected function createQuoteRequestReader(): QuoteRequestReaderInterface
    {
        return $this->getFactory()->createCompanyUserQuoteRequestReader();
    }

    protected function createQuoteRequestCostCenterWriter(): QuoteRequestCostCenterWriterInterface
    {
        return $this->getFactory()->createQuoteRequestCostCenterWriter();
    }
}
