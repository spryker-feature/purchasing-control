 ...
 */
class CostCenterSearchForm extends AbstractType
{
    ...
    public const string OPTION_BUSINESS_UNIT_CHOICES = 'OPTION_BUSINESS_UNIT_CHOICES';

    public const string FORM_NAME = 'costCenterSearchForm';
    ...
    protected function addFiltersField(FormBuilderInterface $builder, array $options): static
    {
        $builder->add(
            ...
            CostCenterSearchFilterSubForm::class,
            [
